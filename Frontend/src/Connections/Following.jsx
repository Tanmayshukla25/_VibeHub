...
const Following = () => {
  ...
  // ✅ Fetch logged-in user (to confirm who is active)
  useEffect(() => {
  ...
  useEffect(() => {
    const fetchFollowing = async () => {
      try {
        const { data } = await instance.get("/follow/me/following", {
          withCredentials: true,
        });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 p-5">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-xl font-semibold text-slate-800">Following</h2>
      </div>
